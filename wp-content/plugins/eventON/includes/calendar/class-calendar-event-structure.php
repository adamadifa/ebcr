					...
					case 'learnmoreICS':						
						...
						// add to cal section
							switch($addCaloptions){
								...
								break;
								case 'gcal':
									$addCalContent = "<a href='". htmlspecialchars($__googlecal_link). "' target='_blank' class='evo_ics_gCal' title='".eventon_get_custom_language($evoOPT2, 'evcal_evcard_addgcal','Add to google calendar')."'>".eventon_get_custom_language($evoOPT2, 'evcal_evcard_calgcal','GoogleCal')."</a>";
								break;
								case 'all':
									$addCalContent = "<a href='{$__ics_url}' class='evo_ics_nCal' title='".eventon_get_custom_language($evoOPT2, 'evcal_evcard_addics','Add to your calendar')."'>".eventon_get_custom_language($evoOPT2, 'evcal_evcard_calncal','Calendar')."</a>".
								...
								<div class='evo_metarow_rel_events evorow evcal_evdata_row'>
									...
									<div class='evcal_evdata_cell'>
										...
										foreach($events as $I=>$N){
											...
											$rel_events[ $I .'.'. $EE->get_start_time() ] =  "<a href='". $EE->get_permalink($x). "'><b>{$N}</b><em>{$time}</em></a>";
										}
