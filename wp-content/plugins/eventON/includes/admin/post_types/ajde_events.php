...
class evo_ajde_events{
	...
	// Columns for events page
		function eventon_edit_event_columns( $existing_columns ) {
			...
			$columns["evo_featured"] = '<span class="evo_posttable evo_posttable_featured ajdeToolTip L" data-label=" '. __( 'Featured', 'eventon' ) .'"><em>'. __( 'Featured', 'eventon' ) .'</em></span>';
			
			$columns["repeat"] = '<span class="evo_posttable evo_posttable_repeat ajdeToolTip L" data-label=" '. __( 'Event Repeat', 'eventon' ) .'"><em>'. __( 'Event Repeat', 'eventon' ) .'</em></span>';
